...
public class Starter {
    ...
    public static final String TASK_QUEUE = "blockQueue";
    ...
    public static void main(String[] args) {
        ...
        WorkflowOptions workflowOptions =
                WorkflowOptions.newBuilder()
                        .setWorkflowId("toBlockWorkflow")
                        .setTaskQueue(TASK_QUEUE)
                        .build();

        // Get the Workflow stub
        HelloWorldNew myWorkflowStub = client.newWorkflowStub(HelloWorldNew.class, workflowOptions);

        String message = "Hello";
        // Start workflow async
        WorkflowExecution execution = WorkflowClient.start(myWorkflowStub::sayHello, message);

        // Let it run for a couple of seconds
        sleepSeconds(60);

        myWorkflowStub.updateGreeting("Hello");
    ...
    private static void createWorker() {
        ...
        worker.registerWorkflowImplementationTypes(HelloWorldNewImpl.class);
